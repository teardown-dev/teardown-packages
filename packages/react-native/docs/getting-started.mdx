...
| `storageAdapter` | StorageAdapter | Yes | Storage adapter instance ([see storage](/docs/react-native/storage)) |
| `deviceAdapter` | DeviceInfoAdapter | Yes | Device info adapter ([see device-info](/docs/react-native/device-info)) |
